...
public class ErrorStatusHTML {
    ...
    public static String getMailBdy() {
        ...
        public static String getUnsubmitLrMailBdy() {
            String templateCode = CallDBQuery.getDetailsForUnsubmitLRJob("TemplateCode");
        String htmlBody = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "<head>\n"
                + "<!-- HTML Codes by Quackit.com -->\n"
                ...
                + "<h1></h1>\n"
                + "<h4>Dear All,</h4>\n"
                + "<p>Please find the attachments of "+"Unsubmitted Leave resumption Employee List"+"</p>\n"
//                + "<p>Please find the attachments of Anwa, SterlingWest, SterlingEast and PRO-001 UnitPriceList.</p>\n"
                + "</br>\n"
                + "<p></p>\n"
                + "<p>Regards,</p>"
                + "<p>NARESCO Administrator Team.</p>\n"
                + "<p></p>\n"
                + "<p style=\"color:red;\">Note: This is a system generated mail so please do not reply to this mail</p>\n"
                + "\n"
                + "<p></p>\n"
